...
-- Fix Hive Drone Aggro Range
UPDATE `creature_ai_scripts` SET `x` = '25' WHERE `creature_ai_scripts`.`id` = 413301 AND `creature_ai_scripts`.`delay` = 0 AND `creature_ai_scripts`.`priority` = 0 AND `creature_ai_scripts`.`command` = 50 AND `creature_ai_scripts`.`datalong` = 0 AND `creature_ai_scripts`.`datalong2` = 0 AND `creature_ai_scripts`.`datalong3` = 0 AND `creature_ai_scripts`.`datalong4` = 0 AND `creature_ai_scripts`.`target_param1` = 0 AND `creature_ai_scripts`.`target_param2` = 0 AND `creature_ai_scripts`.`target_type` = 0 AND `creature_ai_scripts`.`data_flags` = 0 AND `creature_ai_scripts`.`dataint` = 0 AND `creature_ai_scripts`.`dataint2` = 0 AND `creature_ai_scripts`.`dataint3` = 0 AND `creature_ai_scripts`.`dataint4` = 0 AND CONCAT(`creature_ai_scripts`.`x`) = 25 AND CONCAT(`creature_ai_scripts`.`y`) = 0 AND CONCAT(`creature_ai_scripts`.`z`) = 0 AND CONCAT(`creature_ai_scripts`.`o`) = 0 AND `creature_ai_scripts`.`condition_id` = 0 AND `creature_ai_scripts`.`comments` = 'Silithid Hive Drone - Call for Help' LIMIT 1;
UPDATE `creature_ai_scripts` SET `x` = '25' WHERE `creature_ai_scripts`.`id` = 413302 AND `creature_ai_scripts`.`delay` = 0 AND `creature_ai_scripts`.`priority` = 0 AND `creature_ai_scripts`.`command` = 50 AND `creature_ai_scripts`.`datalong` = 0 AND `creature_ai_scripts`.`datalong2` = 0 AND `creature_ai_scripts`.`datalong3` = 0 AND `creature_ai_scripts`.`datalong4` = 0 AND `creature_ai_scripts`.`target_param1` = 0 AND `creature_ai_scripts`.`target_param2` = 0 AND `creature_ai_scripts`.`target_type` = 0 AND `creature_ai_scripts`.`data_flags` = 0 AND `creature_ai_scripts`.`dataint` = 0 AND `creature_ai_scripts`.`dataint2` = 0 AND `creature_ai_scripts`.`dataint3` = 0 AND `creature_ai_scripts`.`dataint4` = 0 AND CONCAT(`creature_ai_scripts`.`x`) = 25 AND CONCAT(`creature_ai_scripts`.`y`) = 0 AND CONCAT(`creature_ai_scripts`.`z`) = 0 AND CONCAT(`creature_ai_scripts`.`o`) = 0 AND `creature_ai_scripts`.`condition_id` = 0 AND `creature_ai_scripts`.`comments` = 'Silithid Hive Drone - Call for Help' LIMIT 1;
